...
public interface ISolutionStrategy {
	...
	/**
	 * Aplica las {@link BridgeDesign estrategias de construcción de puentes}
	 * aplicables y definidos por el {@link IBridgeDesigner diseñador de
	 * puentes}. Construye los puentes desde la isla origen.
	 * 
	 * @param board
	 *            tablero de juego.
	 * 
	 * @return número de puentes trazados.
	 */
